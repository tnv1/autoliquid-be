...
pub struct IndexerMetrics {
    pub(crate) total_transactions: IntCounter,
...
impl IndexerMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            total_transactions: register_int_counter_with_registry!(
                "indexer_total_transactions",
                "Total number of transactions",
                registry,
            )
            .unwrap(),
            backfill_tasks_remaining_checkpoints: register_int_gauge_vec_with_registry!(
                "indexer_backfill_tasks_remaining_checkpoints",
            ...
            tasks_processed_checkpoints: register_int_counter_vec_with_registry!(
                "indexer_tasks_processed_checkpoints",
            ...
            tasks_latest_retrieved_checkpoints: register_int_gauge_vec_with_registry!(
                "indexer_tasks_latest_retrieved_checkpoints",
...
impl IndexerMetricProvider for IndexerMetrics {
